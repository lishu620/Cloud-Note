...
![image-20221204161431863](https://img.mlishu.xyz/image-20221204161431863.png)
...
以下是我的网站测速结果，也可通过访问 [mlishu.xyz 在全国各地区网络速度测试情况-Ping.cn](https://www.ping.cn/http/mlishu.xyz) 在线查看

![image-20221204161146327](https://img.mlishu.xyz/image-20221204161146327.png)
...
由于代码提交到代码仓库(github)，则需要借用 CI 服务来帮助我们完成这些任务，这里我使用了 [Github Action](https://github.com/marketplace) 来帮助我构建，构建记录可以在 [Actions · mlishu/blog](https://github.com/mlishu/blog/actions) 中查看。以下是我的配置文件
    ...
    steps:
      ...
      - name: SSH Deploy
        ...
        env:
          ...
          REMOTE_USER: 'root'
          TARGET: '/opt/1panel/apps/openresty/openresty/www/sites/mlishu.xyz/index'
```
...
当然了上述只是我的配置方案，有许多伙伴可能没有自己的域名或者自己的服务器，就想着白嫖，那么这里目前我只能推荐 [Netlify](https://www.netlify.com/)，然后通过 netlify 的二级域名如 mlishu-blog.netlify.app 来进行访问。
