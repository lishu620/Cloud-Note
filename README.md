...
如果你想要搭建一个类似的站点，可直接 [Fork](https://github.com/mlishu/blog/fork) 本仓库使用，或者通过 [StackBlitz](https://stackblitz.com/github/mlishu/blog) 在线运行本项目，通过 [Vercel](https://vercel.com/new/clone?repository-url=https://github.com/mlishu/blog/tree/main&project-name=blog&repo-name=blog) 一键部署。
...
我的主题魔改实现：[Docusaurus 主题魔改](https://mlishu.cn/docs/docusaurus-guides)
...
```bash
git clone https://github.com/mlishu/blog.git
cd blog
pnpm install
pnpm start
```
